...
mean_iat = 0.02  # mean inter arrival time in seconds


def write_request_log(request_type, name, response_time, response_length,
    ...
    with open("requests_log.txt", "a") as f:
        f.write(
            f"{current_time} {request_type} {name} {response_time}ms \
              {response_length}\n")
...
def on_request(request_type, name, response_time, response_length, exception,
               context, **kwargs):
    write_request_log(request_type, name, response_time,
...
class LoadTestUser(HttpUser):
    ...
    # def wait_time(self):
    #     return mean_iat  # 50 requests per second
        ...
        for _ in range(5):  # Retry up to 5 times
            with self.client.post(path, data=body, headers=headers, catch_response=True) as response:
                if response.status_code == 200:
                    ...
                    response.failure("Failed to submit review")
